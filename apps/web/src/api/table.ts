...
export type Name = keyof typeof CAPABILITIES
 ...
 */
export type Args<K extends Name> = (typeof CAPABILITIES)[K]["takes"] extends Shape<infer A> ? A : never

export type Answer<K extends Name> = (typeof CAPABILITIES)[K]["run"] extends (
  args: never,
) => Promise<Result<infer R, Hitch>>
  ? R
  : never

export const NAMES: readonly Name[] = Object.keys(CAPABILITIES) as readonly Name[]
