...
export const ja: Dictionary = {
  ...
  books: {
    ...
    needsToken: "先にパーソナルアクセストークンの登録が要ります。GitHub に届くのはそれで、どの帳簿でも同じものを使います。",
    goAndSaveOne: "ソース管理でトークンを登録する →",
  ...
  git: {
    ...
    send: "送る",
    take: "取り込む",
    noChanges: "送信待ちの変更はありません。",
    added: "追加 ── リポジトリにまだ無いファイル",
    modified: "変更 ── 前回送ってから書き換わったファイル",
    message: "メッセージ",
    ...
    reading: "履歴を読んでいます…",
    readAgain: "読み直す",
    noCommits: "リポジトリにはまだコミットがありません。",
    older: "さらに古い {{ count }} 件",
    keptOnly: "GitHub に問い合わせ直せなかったので、先に読んだ分を表示しています。",
    chooseCommit: "コミットを選ぶと、何を変えたかが見られます。",
    readingCommit: "コミットを読んでいます…",
    filesChanged: "{{ count }} ファイルを変更",
    noPatch: "このファイルの変更は GitHub から届きませんでした。大きすぎるか、テキストではありません。",
    hidden: "変更のない {{ count }} 行",
    sinceSent: "前回送ってから",
    back: "履歴に戻る",
  },
  licenses: {
