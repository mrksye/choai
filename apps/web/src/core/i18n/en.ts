...
export const en = {
  ...
  books: {
    ...
    needsToken: "A personal access token has to be saved first — it is what reaches GitHub, and it is saved once for every book.",
    goAndSaveOne: "Save a token in source control →",
  ...
  git: {
    ...
    send: "Send",
    take: "Take",
    noChanges: "Nothing is waiting to be sent.",
    added: "Added — the repository has never had this file",
    modified: "Modified since it was last sent",
    message: "Message",
    ...
    older: "{{ count }} older",
    keptOnly: "GitHub could not be asked again, so this is what was read before.",
    chooseCommit: "Choose a commit to see what it changed.",
    readingCommit: "Reading the commit…",
    filesChanged: "{{ count }} files changed",
    noPatch: "GitHub did not send the change to this file: it is too large, or it is not text.",
    hidden: "{{ count }} unchanged lines",
    sinceSent: "Since it was last sent",
