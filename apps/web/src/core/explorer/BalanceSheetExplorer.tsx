 ...
 */
export function BalanceSheetExplorer(props: {
    ...
    >
      {(open) => (
        <div class="py-1">
          ...
          <For each={byTop(ofKindsNow(open().summary.accounts, OWNED_AND_OWED))}>
            {(branch) => (
              <div>
