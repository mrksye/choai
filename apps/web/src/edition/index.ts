 ...
 * edition being built; `paths`, with the standard edition, which is what the
 ...
 *
 * It was once a file that re-exported the standard edition, and was once imported
 ...
 * standard one, because what the build swaps is the name. There is nothing to
 * spell that way now.
 */
export { edition }
